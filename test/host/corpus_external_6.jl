# External-corpus shard 6 of 6 — lossless acceptance, RawLine-manifest
...
const _SHARD_FILES = external_corpus_shard(6)
...
@testset "external RawLine fallback inventory (shard 6)" begin
