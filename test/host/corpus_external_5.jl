# External-corpus shard 5 of 6 — lossless acceptance, RawLine-manifest
...
const _SHARD_FILES = external_corpus_shard(5)
...
@testset "external RawLine fallback inventory (shard 5)" begin
