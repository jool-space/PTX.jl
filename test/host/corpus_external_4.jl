# External-corpus shard 4 of 6 — lossless acceptance, RawLine-manifest
...
const _SHARD_FILES = external_corpus_shard(4)
...
@testset "external RawLine fallback inventory (shard 4)" begin
