# External-corpus shard 2 of 6 — lossless acceptance, RawLine-manifest
...
const _SHARD_FILES = external_corpus_shard(2)
...
@testset "external RawLine fallback inventory (shard 2)" begin
