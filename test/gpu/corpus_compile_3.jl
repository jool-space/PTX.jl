...
# ptxas external-corpus shard 3 of 4 — ptxas-acceptance of this shard's slice
...
@testset "ptxas accepts source + structural re-emit ($(basename(path)))" for (path, arch) in ptxas_corpus_shard(3)
