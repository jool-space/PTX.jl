...
@inline (::Operation{:bar, (:sync,)})(id::_BarrierOperand) =
...
@inline (::Operation{:bar, (:warp, :sync)})(mask::_BarrierOperand) =
    nvvm"bar.warp.sync"(_barrier_u32(mask))

# `bar.arrive a, b;` — arrive without waiting; count is mandatory.
@inline (::Operation{:bar, (:arrive,)})(id::_BarrierOperand,
                                        count::_BarrierOperand) =
...
@inline (::Operation{:barrier, (:sync,)})(id::_BarrierOperand) =
...
@inline (::Operation{:barrier, (:sync, :aligned)})(id::_BarrierOperand) =
    nvvm"barrier.cta.sync.aligned.all"(_barrier_u32(id))
@inline (::Operation{:barrier, (:sync, :aligned)})(id::_BarrierOperand,
                                                   count::_BarrierOperand) =
    nvvm"barrier.cta.sync.aligned.count"(_barrier_u32(id),
...
@inline (::Operation{:barrier, (:arrive,)})(id::_BarrierOperand,
                                            count::_BarrierOperand) =
    nvvm"barrier.cta.arrive.count"(_barrier_u32(id), _barrier_u32(count))
@inline (::Operation{:barrier, (:arrive, :aligned)})(id::_BarrierOperand,
                                                     count::_BarrierOperand) =
    nvvm"barrier.cta.arrive.aligned.count"(_barrier_u32(id),
                                           _barrier_u32(count))
